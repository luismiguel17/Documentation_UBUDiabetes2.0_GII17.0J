...
\imagen{Registro_Perfil_Mario}{Registro-Perfil UBUDiabetes 1.0}{0.3}
\newpage
...
\begin{itemize}
	...
	\imagen{Android_Configurations}{Configuraciones build.gradle A}{0.9}
	\imagen{Android_Dependencies}{Configuraciones build.gradle B}{0.9}
