...
\imagen{SplashScreen}{Splash Screen}{0.6}
...
\imagen{Registro_Perfil_Mario}{Registro-Perfil UBUDiabetes 1.0}{0.6}
\newpage
...
\begin{itemize}
	...
	\imagen{raciones_UBUDiabetes1}{Raciones de HC-UBUDiabetes 1.0}{0.4}
